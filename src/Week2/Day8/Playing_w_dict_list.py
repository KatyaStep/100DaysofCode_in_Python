...
def get_every_nth_state(states=states, n=10):
    ...
    for index in states[n - 1::n]:
        nth_state.append(index)
...
def combine_state_names_and_abbreviations(us_state_abbrev=us_state_abbrev,
    ...
    for abbrev in list(us_state_abbrev.values())[0:num_of_state]:
        combine_states.append(abbrev)

    combine_states.sort()

    for state in states[-num_of_state:]:
